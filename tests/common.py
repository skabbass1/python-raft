...
def start_state_machine(
    ...
    state_machine = StateMachine(
        node_config=name or leader_state_machine_name(),
...
def start_log_writer(log_location, max_buffer_size, incoming_message_queue):
...
def start_snapshot_writer(
    snapshot_location, state_machine_message_queue, incoming_message_queue
):
